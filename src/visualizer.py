...
class Visualizer:
    ...
    def visualizeInstance(self):
        ...
        nnull_cells = self.deployment.getNonNullCells()
...
if __name__ == "__main__":
    ...
    found_sol = [3, 1, 2, 4, 1, 0, 1, 3, 1, 4, 2, 1, 1, 4, 2, 0, 0, 2, 4, 1, 1, 1, 2, 1, 0, 0, 0, 1, 0, 4, 4, 2, 4, 0, 4, 1, 2, 1, 1, 1, 2, 1, 0, 1, 2, 0, 1, 4, 1, 2]

    dep = Deployment(instance = ins, deployment = found_sol)
    vis = Visualizer(instance = ins, deployment = dep)
    vis.visualizeInstance()